...
public class HomeActivity extends AppCompatActivity {
    ...
    private static final int PICK_IMAGE_REQUEST = 3333;
    ...
    private void init() {
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            if(item.getItemId() == R.id.nav_sign_out)
            {
                ...
                builder.setTitle("Sign out")
                        .setMessage("Sunteti sigur ca vreti sa iesiti?")
        ...
        if(Common.currentClient!=null && Common.currentClient.getAvatar()!=null &&
                !TextUtils.isEmpty(Common.currentClient.getAvatar()))
        {
            Glide.with(this)
                    .load(Common.currentClient.getAvatar())
                    .into(img_avatar);
        }
    }
    ...
    private void showDialogUpload() {
        AlertDialog.Builder builder= new AlertDialog.Builder(HomeActivity.this);
        builder.setTitle("Schimbă fotografia")
                .setMessage("Sigur schimbați fotografia?")
                .setNegativeButton("Anulează", (dialog, which) -> dialog.dismiss())
                .setPositiveButton("SCHIMBĂ", (dialog, which) -> {
                    if(imageUri!=null)
                    {
                                ...
                                }).addOnCompleteListener(task ->
                        {
                            ...
                            waitingDialog.setMessage(new StringBuilder("Se incarca: ").append(progress).append("%"));
                        });
                    }
                })
                .setCancelable(false);
